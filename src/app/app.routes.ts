...
export const routes: Routes = [
  ...
  },
  {
    path: 'inicio-sesion',
    loadComponent: () =>
      import('./pages/inicio-sesion/inicio-sesion.page').then(
        (m) => m.InicioSesionPage
      ),
  },
  {
    path: 'home',
  ...
  },
  {
    path: 'registrarse',
    loadComponent: () =>
      import('./pages/registrarse/registrarse.page').then(
        (m) => m.RegistrarsePage
      ),
  },
  {
  ...
  {
    path: 'tree-detail/:id', // ← ahora la ruta acepta parámetro id
    loadComponent: () =>
